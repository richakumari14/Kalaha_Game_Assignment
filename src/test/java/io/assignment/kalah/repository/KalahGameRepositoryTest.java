...
public class KalahGameRepositoryTest {
	...
	public void testFind() {
		final KalahGame given = repository.save(new KalahGame(pitStoneCount));
		final KalahGame when = repository.findById(given.getId());
	...
	public void testSave() {
		final KalahGame game = repository.save(new KalahGame(pitStoneCount));
